#
# Be sure to run `pod lib lint json-to-swiftui-renderer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of json-to-swiftui-renderer.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'json-to-swiftui-renderer' => ['json-to-swiftui-renderer/Assets/*.png']
  # }
